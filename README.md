...
| **[catchup](./catchup)** | Bring a **stale local repo** up to date with the remote's main branch — fetch, fast-forward, prune remote-tracking refs, and delete local branches whose PRs have merged — then report the git facts. Never touches in-flight branches or uncommitted work. |
